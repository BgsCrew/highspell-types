...
export namespace Core {
  ...
  export const WildernessManager = Generated.Managers.WildernessManager.Instance;
  ...
  export const AtmosphereManager = Generated.Managers.AtmosphereManager.Instance;
  ...
  export const SpellActionManager = Generated.Managers.SpellActionManager.Instance;
  ...
  export const WorldEntityManger = Generated.Managers.WorldEntityManger.Instance;
  export const GroundItemManager = Generated.Managers.GroundItemManager.Instance;
  ...
  export const AppearanceManager = Generated.Managers.AppearanceManager.Instance;
  ...
  export const ProjectileManager = Generated.Managers.ProjectileManager.Instance;
  export const ChatFilterManager = Generated.Managers.ChatFilterManager.Instance;
  export const SocialManager = Generated.Managers.SocialManager.Instance;
  export const PlayerStatsManager = Generated.Managers.PlayerStatsManager.Instance;
  ...
  export const UnknownManager_jM = Generated.Managers.UnknownManager_jM.Instance;
}
